...
PATCH https://api.erebor.bank/business_applicants/{id}
Content-Type: application/json

Update a business applicant's `custom_ref` or `custom_fields`. Identity fields used for KYC are immutable.

Reference: https://docs.erebor.bank/api-reference/onboarding/business-applicants/update-business-applicant
...
paths:
  /business_applicants/{id}:
    patch:
      operationId: update-business-applicant
      summary: Update Business Applicant
      description: >-
        Update a business applicant's `custom_ref` or `custom_fields`. Identity
        fields used for KYC are immutable.
      tags:
      ...
      responses:
        '200':
          description: Business applicant updated successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/UpdateBusinessApplicantRequest'
servers:
...
components:
  schemas:
    ...
    CustomFields:
      ...
      title: CustomFields
    UpdateBusinessApplicantRequest:
      type: object
      properties:
        custom_ref:
      ...
      title: UpdateBusinessApplicantRequest
...
```javascript
const url = 'https://api.erebor.bank/business_applicants/biz_app_01kasd1tthf1ns1pjn1kncctwd';
const options = {
  method: 'PATCH',
  headers: {Authorization: '<apiKey>', 'Content-Type': 'application/json'},
  body: '{"custom_ref":"APPLICANT-7821","custom_fields":{"referral_source":"partner_program","internal_id":"APPLICANT-7821"}}'
};
...
url = URI("https://api.erebor.bank/business_applicants/biz_app_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/business_applicants/biz_app_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/business_applicants/biz_app_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "APPLICANT-7821",
  "custom_fields": {
    "referral_source": "partner_program",
...
var client = new RestClient("https://api.erebor.bank/business_applicants/biz_app_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/business_applicants/biz_app_01kasd1tthf1ns1pjn1kncctwd")! as URL,
