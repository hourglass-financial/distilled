...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/ach_in/in_ach_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/ach_in/in_ach_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "INBOUND-ACH-2025-04812",
  "custom_fields": {
    "invoice_id": "INV-2025-04812",
