...
GET https://api.erebor.bank/international_wire_in/{id}

Retrieve a specific Inbound International Wire by ID


Reference: https://docs.erebor.bank/api-reference/payments/international-wire/inbound/get-inbound-international-wire-transfer
...
paths:
  /international_wire_in/{id}:
    get:
      operationId: get-inbound-international-wire-transfer
      summary: Retrieve Inbound International Wire
      description: |
        Retrieve a specific Inbound International Wire by ID
      tags:
      ...
      responses:
        '200':
          description: Inbound International Wire details
          content:
            application/json:
              schema:
...
HttpResponse<String> response = Unirest.get("https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('GET', 'https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd', [
  'headers' => [
