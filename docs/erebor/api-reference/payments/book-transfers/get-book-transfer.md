...
GET https://api.erebor.bank/book_transfers/{id}

Retrieve a specific Book Transfer by ID

Reference: https://docs.erebor.bank/api-reference/payments/book-transfers/get-book-transfer
...
paths:
  /book_transfers/{id}:
    get:
      ...
      summary: Retrieve Book Transfer
      description: Retrieve a specific Book Transfer by ID
      tags:
      ...
      responses:
        '200':
          description: Book transfer details
          content:
            application/json:
              schema:
...
HttpResponse<String> response = Unirest.get("https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('GET', 'https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd', [
  'headers' => [
