...
POST https://api.erebor.bank/deposit_accounts
Content-Type: application/json

Create a new Deposit Account

Reference: https://docs.erebor.bank/api-reference/accounts/deposit-accounts/create-deposit-account
...
paths:
  /deposit_accounts:
    post:
      operationId: create-deposit-account
  ...
  schemas:
    ...
    CreateDepositAccountRequest:
      ...
      required:
        ...
        - customer_id
        - disclosures
      title: CreateDepositAccountRequest
...
const options = {
  ...
  body: '{"deposit_account_template_id":"dep_acct_tmpl_01kasd1tthf1ns1pjn1kncctwd","customer_id":"cust_01kasd1tthf1ns1pjn1kncctwd","disclosures":{"disclosures_signed_externally":true},"name":"Main Business Account","custom_ref":"GL-OPERATING-USD","custom_fields":{"cost_center":"engineering","ledger_code":"1100"}}'
};
...
HttpResponse<String> response = Unirest.post("https://api.erebor.bank/deposit_accounts")
...
$response = $client->request('POST', 'https://api.erebor.bank/deposit_accounts', [
  'body' => '{
  "deposit_account_template_id": "dep_acct_tmpl_01kasd1tthf1ns1pjn1kncctwd",
  "customer_id": "cust_01kasd1tthf1ns1pjn1kncctwd",
  "disclosures": {
