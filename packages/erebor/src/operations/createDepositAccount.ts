...
export const CreateDepositAccountInput =
  ...
  }).pipe(T.Http({ method: "POST", path: "/deposit_accounts" }));
export type CreateDepositAccountInput = typeof CreateDepositAccountInput.Type;
...
export type CreateDepositAccountOutput = typeof CreateDepositAccountOutput.Type;
