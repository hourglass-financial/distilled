...
export const ListInboundBlockchainTransfersInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/blockchain_in" }));
export type ListInboundBlockchainTransfersInput =
  typeof ListInboundBlockchainTransfersInput.Type;
...
export type ListInboundBlockchainTransfersOutput =
  typeof ListInboundBlockchainTransfersOutput.Type;
