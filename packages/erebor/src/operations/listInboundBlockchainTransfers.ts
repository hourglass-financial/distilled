...
// Input Schema
export interface ListInboundBlockchainTransfersInput {
  page_size?: number;
...
export const ListInboundBlockchainTransfersInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/blockchain_in" }),
  ) as unknown as GeneratedStructCodec<ListInboundBlockchainTransfersInput>;

// Output Schema
export interface ListInboundBlockchainTransfersOutput {
  data: ReadonlyArray<{
    id: string;
    type: "BLOCKCHAIN_IN";
    url: string;
...
export const ListInboundBlockchainTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
        id: Schema.String,
    ...
    url: Schema.String,
  }) as unknown as GeneratedStructCodec<ListInboundBlockchainTransfersOutput>;
 ...
 */
export const listInboundBlockchainTransfers =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: ListInboundBlockchainTransfersInput,
    outputSchema: ListInboundBlockchainTransfersOutput,
  }));
