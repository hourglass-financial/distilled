...
export const ListOutboundRailTransfersInput =
  ...
  ) as unknown as GeneratedStructCodec<ListOutboundRailTransfersInput>;
...
export const ListOutboundRailTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as GeneratedStructCodec<ListOutboundRailTransfersOutput>;
 ...
 */
export const listOutboundRailTransfers = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListOutboundRailTransfersInput,
    outputSchema: ListOutboundRailTransfersOutput,
  }),
);
