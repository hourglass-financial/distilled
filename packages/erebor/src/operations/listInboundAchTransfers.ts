...
// Input Schema
export interface ListInboundAchTransfersInput {
  page_size?: number;
...
export const ListInboundAchTransfersInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/ach_in" }),
  ) as unknown as GeneratedStructCodec<ListInboundAchTransfersInput>;

// Output Schema
export interface ListInboundAchTransfersOutput {
  data: ReadonlyArray<{
    id: string;
    type: "ACH_IN";
    url: string;
...
export const ListInboundAchTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
        id: Schema.String,
    ...
    url: Schema.String,
  }) as unknown as GeneratedStructCodec<ListInboundAchTransfersOutput>;
 ...
 */
export const listInboundAchTransfers = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListInboundAchTransfersInput,
    outputSchema: ListInboundAchTransfersOutput,
  }),
);
