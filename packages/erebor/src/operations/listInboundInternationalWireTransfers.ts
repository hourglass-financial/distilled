...
// Input Schema
export interface ListInboundInternationalWireTransfersInput {
  page_size?: number;
...
export const ListInboundInternationalWireTransfersInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/international_wire_in" }),
  ) as unknown as GeneratedStructCodec<ListInboundInternationalWireTransfersInput>;

// Output Schema
export interface ListInboundInternationalWireTransfersOutput {
  data: ReadonlyArray<{
    id: string;
...
export const ListInboundInternationalWireTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as GeneratedStructCodec<ListInboundInternationalWireTransfersOutput>;
