...
// Input Schema
export interface ListOutboundInternationalWireTransfersInput {
  page_size?: number;
...
export const ListOutboundInternationalWireTransfersInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/international_wire_out" }),
  ) as unknown as GeneratedStructCodec<ListOutboundInternationalWireTransfersInput>;

// Output Schema
export interface ListOutboundInternationalWireTransfersOutput {
  data: ReadonlyArray<{
    id: string;
...
export const ListOutboundInternationalWireTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as GeneratedStructCodec<ListOutboundInternationalWireTransfersOutput>;
