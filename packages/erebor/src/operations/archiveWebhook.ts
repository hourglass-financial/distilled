...
// Output Schema
export const ArchiveWebhookOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type ArchiveWebhookOutput = typeof ArchiveWebhookOutput.Type;
...
export const archiveWebhook = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  outputSchema: ArchiveWebhookOutput,
