...
export const ListInboundWireTransfersInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/wire_in" }));
export type ListInboundWireTransfersInput =
  typeof ListInboundWireTransfersInput.Type;
...
export type ListInboundWireTransfersOutput =
  typeof ListInboundWireTransfersOutput.Type;
