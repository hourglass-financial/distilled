  ...
  describe("happy path", () => {
    it(
      ...
      async () => {
        ...
        // billing_deposit_account_id is now optional (omitted for MANAGED
        // programs). Only assert its type when the field is present.
        if (result.billing_deposit_account_id !== undefined) {
