/**
 * Tests for the `updateCounterpartyUsBankAccount` operation.
 *
 * Happy path discovers a real id via `listCounterpartyUsBankAccounts` and
...
import { updateCounterpartyUsBankAccount } from "../src/operations/updateCounterpartyUsBankAccount.ts";
import { runEffect, testRunId, unknownId } from "./setup.ts";

describe("updateCounterpartyUsBankAccount", () => {
  describe("happy path", () => {
    it(
      "patches description, custom_ref and custom_fields on an existing counterparty US bank account",
      async () => {
