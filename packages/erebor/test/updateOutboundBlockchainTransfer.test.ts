/**
 * Tests for the `updateOutboundBlockchainTransfer` operation.
 *
...
import { updateOutboundBlockchainTransfer } from "../src/operations/updateOutboundBlockchainTransfer.ts";
import { runEffect, testRunId, unknownId } from "./setup.ts";

describe("updateOutboundBlockchainTransfer", () => {
  describe("happy path", () => {
    it(
      "patches custom_ref and custom_fields on an existing outbound blockchain transfer",
      async () => {
        ...
        const result = await runEffect(
          updateOutboundBlockchainTransfer({
            id: target.id,
            custom_ref: newRef,
