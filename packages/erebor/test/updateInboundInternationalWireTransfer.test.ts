...
import { updateInboundInternationalWireTransfer } from "../src/operations/updateInboundInternationalWireTransfer.ts";
import { runEffect, testRunId, unknownId } from "./setup.ts";

describe("updateInboundInternationalWireTransfer", () => {
  describe("happy path", () => {
    it("patches custom_ref and custom_fields on an existing inbound international wire transfer", async () => {
      ...
      const result = await runEffect(
        updateInboundInternationalWireTransfer({
          id: target.id,
          custom_ref: newRef,
