...
import { updateOutboundRailTransfer } from "../src/operations/updateOutboundRailTransfer.ts";
import { runEffect, testRunId, unknownId } from "./setup.ts";

describe("updateOutboundRailTransfer", () => {
  describe("happy path", () => {
    it("patches custom_ref and custom_fields on an existing outbound rail transfer", async () => {
