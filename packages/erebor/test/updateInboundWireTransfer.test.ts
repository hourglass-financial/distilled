...
import { updateInboundWireTransfer } from "../src/operations/updateInboundWireTransfer.ts";
import { runEffect, testRunId, unknownId } from "./setup.ts";

describe("updateInboundWireTransfer", () => {
  describe("happy path", () => {
    it("patches custom_ref and custom_fields on an existing inbound wire transfer", async () => {
