...
GET https://api.erebor.bank/counterparty_us_bank_accounts/{id}

Retrieve a specific Counterparty US Bank Account by ID

Reference: https://docs.erebor.bank/api-reference/counterparties/us-bank-accounts/get-counterparty-us-bank-account
...
paths:
  /counterparty_us_bank_accounts/{id}:
    get:
      operationId: get-counterparty-us-bank-account
      summary: Retrieve Counterparty US Bank Account
      description: Retrieve a specific Counterparty US Bank Account by ID
      tags:
...
```go Counterparty US Bank Account details
package main
...
```ruby Counterparty US Bank Account details
require 'uri'
require 'net/http'
...
```java Counterparty US Bank Account details
...
```php Counterparty US Bank Account details
<?php
...
```swift Counterparty US Bank Account details
import Foundation
