...
PATCH https://api.erebor.bank/counterparty_international_bank_accounts/{id}
...
Reference: https://docs.erebor.bank/api-reference/counterparties/international-bank-accounts/update-counterparty-international-bank-account
...
paths:
  /counterparty_international_bank_accounts/{id}:
    patch:
      operationId: update-counterparty-international-bank-account
      summary: Update Counterparty International Bank Account
      description: >-
        Update a counterparty international bank account's `description`,
        `custom_ref`, or `custom_fields`. The account number and BIC are
        immutable.
      tags:
      ...
      responses:
        '200':
          description: Counterparty international bank account updated successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/UpdateCounterpartyInternationalBankAccountRequest
servers:
...
components:
  schemas:
    ...
    CustomFields:
      ...
      title: CustomFields
    UpdateCounterpartyInternationalBankAccountRequest:
      type: object
      properties:
        description:
          type: string
      ...
      title: UpdateCounterpartyInternationalBankAccountRequest
...
const options = {
  ...
  body: '{"description":"Euro Account","custom_ref":"CP-IBA-2025-001","custom_fields":{"swift_verified":"true","region":"EMEA"}}'
};
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/counterparty_international_bank_accounts/cp_intl_bank_acct_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/counterparty_international_bank_accounts/cp_intl_bank_acct_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "description": "Euro Account",
  "custom_ref": "CP-IBA-2025-001",
  "custom_fields": {
