...
PATCH https://api.erebor.bank/documents/{id}
Content-Type: application/json

Update a document's `custom_ref` or `custom_fields`. The file contents, name, type, and description are immutable.

Reference: https://docs.erebor.bank/api-reference/onboarding/documents/update-document
...
paths:
  /documents/{id}:
    patch:
      ...
      description: >-
        Update a document's `custom_ref` or `custom_fields`. The file contents,
        name, type, and description are immutable.
      tags:
...
const options = {
  ...
  body: '{"custom_ref":"DOC-2025-7821","custom_fields":{"category":"kyc","applicant":"biz_app_01kasd1tthf1ns1pjn1kncctwd"}}'
};
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/documents/doc_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/documents/doc_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "DOC-2025-7821",
  "custom_fields": {
    "category": "kyc",
