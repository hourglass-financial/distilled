...
PATCH https://api.erebor.bank/person_applicants/{id}
Content-Type: application/json

Update a person applicant's `custom_ref` or `custom_fields`. Identity fields used for KYC are immutable.

Reference: https://docs.erebor.bank/api-reference/onboarding/person-applicants/update-person-applicant
...
paths:
  /person_applicants/{id}:
    patch:
      operationId: update-person-applicant
      summary: Update Person Applicant
      description: >-
        Update a person applicant's `custom_ref` or `custom_fields`. Identity
      ...
      responses:
        '200':
          description: Person applicant updated successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/UpdatePersonApplicantRequest'
servers:
...
```javascript
const url = 'https://api.erebor.bank/person_applicants/prsn_app_01kasd1tthf1ns1pjn1kncctwd';
const options = {
  method: 'PATCH',
...
url = URI("https://api.erebor.bank/person_applicants/prsn_app_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/person_applicants/prsn_app_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/person_applicants/prsn_app_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "APPLICANT-7821",
  "custom_fields": {
    "referral_source": "partner_program",
...
var client = new RestClient("https://api.erebor.bank/person_applicants/prsn_app_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/person_applicants/prsn_app_01kasd1tthf1ns1pjn1kncctwd")! as URL,
