...
PATCH https://api.erebor.bank/onboardings/{id}
Content-Type: application/json

Update an onboarding's `custom_ref` or `custom_fields`. Status, applicant, and program are immutable.

Reference: https://docs.erebor.bank/api-reference/onboarding/onboarding/update-onboarding
...
paths:
  /onboardings/{id}:
    patch:
      ...
      description: >-
        Update an onboarding's `custom_ref` or `custom_fields`. Status,
        applicant, and program are immutable.
      tags:
...
const options = {
  ...
  body: '{"custom_ref":"ONB-2025-7821","custom_fields":{"sales_rep":"j.smith","internal_id":"ONB-2025-7821"}}'
};
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/onboardings/onb_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/onboardings/onb_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "ONB-2025-7821",
  "custom_fields": {
    "sales_rep": "j.smith",
