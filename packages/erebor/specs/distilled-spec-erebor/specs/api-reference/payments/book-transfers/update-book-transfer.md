...
PATCH https://api.erebor.bank/book_transfers/{id}
Content-Type: application/json

Update a book transfer's `custom_ref` or `custom_fields`. Amount, parties, and status are immutable.

Reference: https://docs.erebor.bank/api-reference/payments/book-transfers/update-book-transfer
...
paths:
  /book_transfers/{id}:
    patch:
      operationId: update-book-transfer
      summary: Update Book Transfer
      description: >-
        Update a book transfer's `custom_ref` or `custom_fields`. Amount,
        parties, and status are immutable.
      tags:
      ...
      responses:
        '200':
          description: Book transfer updated successfully
          content:
            application/json:
              schema:
...
components:
  schemas:
    ...
    UpdateBookTransferRequest:
      ...
      title: UpdateBookTransferRequest
    BookTransferStatus:
      type: string
      enum:
        - PENDING
...
```javascript
const url = 'https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd';
const options = {
  method: 'PATCH',
  headers: {Authorization: '<apiKey>', 'Content-Type': 'application/json'},
  body: '{"custom_ref":"INTERNAL-2025-001","custom_fields":{"allocation_type":"monthly_sweep","fiscal_period":"2025-Q1"}}'
};
...
url = URI("https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "INTERNAL-2025-001",
  "custom_fields": {
    "allocation_type": "monthly_sweep",
...
var client = new RestClient("https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/book_transfers/bk_01kasd1tthf1ns1pjn1kncctwd")! as URL,
