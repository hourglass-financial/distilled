...
# The Inbound Rail Transfer Object

An inbound rail transfer represents funds received via a rail network from an external counterparty. These are created automatically when a counterparty sends a rail transfer to your customer's account.

```json title="The Inbound Rail Transfer Object"
{
