...
GET https://api.erebor.bank/international_wire_out/{id}

Retrieve a specific Outbound International Wire by ID


Reference: https://docs.erebor.bank/api-reference/payments/international-wire/outbound/get-outbound-international-wire-transfer
...
paths:
  /international_wire_out/{id}:
    get:
      operationId: get-outbound-international-wire-transfer
      summary: Retrieve Outbound International Wire
      description: |
        Retrieve a specific Outbound International Wire by ID
      tags:
      ...
      responses:
        '200':
          description: Outbound International Wire details
          content:
            application/json:
              schema:
...
HttpResponse<String> response = Unirest.get("https://api.erebor.bank/international_wire_out/intl_wire_out_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('GET', 'https://api.erebor.bank/international_wire_out/intl_wire_out_01kasd1tthf1ns1pjn1kncctwd', [
  'headers' => [
