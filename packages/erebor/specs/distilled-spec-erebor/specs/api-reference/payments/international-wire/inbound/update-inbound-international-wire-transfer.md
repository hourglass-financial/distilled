...
PATCH https://api.erebor.bank/international_wire_in/{id}
...
Reference: https://docs.erebor.bank/api-reference/payments/international-wire/inbound/update-inbound-international-wire-transfer
...
info:
  ...
  version: 1.0.0
paths:
  /international_wire_in/{id}:
    patch:
      operationId: update-inbound-international-wire-transfer
      summary: Update Inbound International Wire
      description: >-
        Update an inbound international wire transfer's `custom_ref` or
        `custom_fields` for reconciliation. All other fields are immutable.
      tags:
        - subpackage_inboundInternationalWireTransfers
      parameters:
        - name: id
          in: path
          description: Inbound International Wire ID
          required: true
          schema:
            type: string
        - name: Authorization
      ...
      responses:
        '200':
          description: Inbound International Wire updated successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/UpdateInboundInternationalWireTransferRequest
servers:
...
components:
  schemas:
    ...
    CustomFields:
      ...
      title: CustomFields
    UpdateInboundInternationalWireTransferRequest:
      type: object
      properties:
        custom_ref:
      ...
      title: UpdateInboundInternationalWireTransferRequest
...
```json
{
  "custom_ref": "INBOUND-INTL-WIRE-2025-001",
  "custom_fields": {
    "invoice_id": "INV-EU-2025-04812",
    "payer": "European Supplier GmbH"
  }
}
```
...
```javascript
const url = 'https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd';
const options = {
  method: 'PATCH',
  headers: {Authorization: '<apiKey>', 'Content-Type': 'application/json'},
  body: '{"custom_ref":"INBOUND-INTL-WIRE-2025-001","custom_fields":{"invoice_id":"INV-EU-2025-04812","payer":"European Supplier GmbH"}}'
};
...
url = URI("https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "INBOUND-INTL-WIRE-2025-001",
  "custom_fields": {
    "invoice_id": "INV-EU-2025-04812",
...
var client = new RestClient("https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/international_wire_in/intl_wire_in_01kasd1tthf1ns1pjn1kncctwd")! as URL,
