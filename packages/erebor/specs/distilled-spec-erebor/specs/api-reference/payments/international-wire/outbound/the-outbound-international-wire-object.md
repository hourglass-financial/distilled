...
# The Outbound International Wire Object

An outbound international wire sends funds via the SWIFT network from a deposit account to an external counterparty's international bank account.

```json title="The Outbound International Wire Object"
{
...
### Schema (`OutboundInternationalWireTransfer`)
