...
POST https://api.erebor.bank/blockchain_out
...
Reference: https://docs.erebor.bank/api-reference/payments/blockchain/outbound/create-outbound-blockchain-transfer
...
paths:
  /blockchain_out:
    post:
      operationId: create-outbound-blockchain-transfer
      summary: Create Outbound Blockchain Transfer
      description: >
        Create a new Outbound Blockchain Transfer.


        Sending to an unsupported network or incorrect address may result in
        permanent loss. Erebor cannot recover these funds.
      tags:
      ...
      responses:
        '200':
          description: Outbound blockchain transfer created successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CreateOutboundBlockchainTransferRequest'
servers:
...
components:
  schemas:
    ...
    CustomFields:
      ...
      title: CustomFields
    CreateOutboundBlockchainTransferRequest:
      type: object
      properties:
        deposit_account_id:
          type: string
          description: Source account for the outbound transfer
        counterparty_blockchain_address_id:
          type: string
          description: Destination blockchain address for the outbound transfer
        amount:
      ...
      required:
        ...
        - amount
        - network
      title: CreateOutboundBlockchainTransferRequest
...
const options = {
  ...
  body: '{"deposit_account_id":"dep_acct_01kasd1tthf1ns1pjn1kncctwd","counterparty_blockchain_address_id":"cp_bc_addr_01kasd1tthf1ns1pjn1kncctwd","amount":{"currency":"USDC","value":"12345"},"network":"ETHEREUM","custom_ref":"PAYOUT-2025-04812","custom_fields":{"payout_batch":"B-2025-04-15","recipient_id":"u_abc123"}}'
};
...
HttpResponse<String> response = Unirest.post("https://api.erebor.bank/blockchain_out")
...
$response = $client->request('POST', 'https://api.erebor.bank/blockchain_out', [
  'body' => '{
  "deposit_account_id": "dep_acct_01kasd1tthf1ns1pjn1kncctwd",
  "counterparty_blockchain_address_id": "cp_bc_addr_01kasd1tthf1ns1pjn1kncctwd",
  "amount": {
