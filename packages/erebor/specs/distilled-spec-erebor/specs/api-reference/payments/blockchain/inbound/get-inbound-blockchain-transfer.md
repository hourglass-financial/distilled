...
GET https://api.erebor.bank/blockchain_in/{id}

Retrieve a specific Inbound Blockchain Transfer by ID

Reference: https://docs.erebor.bank/api-reference/payments/blockchain/inbound/get-inbound-blockchain-transfer
...
paths:
  /blockchain_in/{id}:
    get:
      operationId: get-inbound-blockchain-transfer
      summary: Retrieve Inbound Blockchain Transfer
      description: Retrieve a specific Inbound Blockchain Transfer by ID
      tags:
      ...
      responses:
        '200':
          description: Inbound blockchain transfer details
          content:
            application/json:
              schema:
...
```python Inbound blockchain transfer details
import requests
...
```javascript Inbound blockchain transfer details
...
```go Inbound blockchain transfer details
package main
...
```ruby Inbound blockchain transfer details
require 'uri'
require 'net/http'
...
```java Inbound blockchain transfer details
import com.mashape.unirest.http.HttpResponse;
import com.mashape.unirest.http.Unirest;

HttpResponse<String> response = Unirest.get("https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd")
  .header("Authorization", "<apiKey>")
  .asString();
```

```php Inbound blockchain transfer details
<?php
require_once('vendor/autoload.php');

$client = new \GuzzleHttp\Client();

$response = $client->request('GET', 'https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd', [
  'headers' => [
...
```csharp Inbound blockchain transfer details
using RestSharp;
...
```swift Inbound blockchain transfer details
import Foundation
