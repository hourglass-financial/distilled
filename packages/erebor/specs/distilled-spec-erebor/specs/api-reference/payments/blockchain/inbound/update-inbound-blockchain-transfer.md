...
PATCH https://api.erebor.bank/blockchain_in/{id}
...
Reference: https://docs.erebor.bank/api-reference/payments/blockchain/inbound/update-inbound-blockchain-transfer
...
paths:
  /blockchain_in/{id}:
    patch:
      operationId: update-inbound-blockchain-transfer
      summary: Update Inbound Blockchain Transfer
      description: >-
        Update an inbound blockchain transfer's `custom_ref` or `custom_fields`
        for reconciliation. Counterparty attribution is set via the separate
        `POST /blockchain_in/{id}/attribute` action; all other fields are
        immutable.
      tags:
      ...
      responses:
        '200':
          description: Inbound blockchain transfer updated successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/UpdateInboundBlockchainTransferRequest'
servers:
...
components:
  schemas:
    ...
    CustomFields:
      ...
      title: CustomFields
    UpdateInboundBlockchainTransferRequest:
      type: object
      properties:
        custom_ref:
      ...
      title: UpdateInboundBlockchainTransferRequest
...
```json
{
  "custom_ref": "INBOUND-BC-2025-04812",
  "custom_fields": {
...
```javascript
const url = 'https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd';
const options = {
  method: 'PATCH',
  headers: {Authorization: '<apiKey>', 'Content-Type': 'application/json'},
  body: '{"custom_ref":"INBOUND-BC-2025-04812","custom_fields":{"invoice_id":"INV-2025-04812","sender":"Acme Corporation"}}'
};
...
url = URI("https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "INBOUND-BC-2025-04812",
  "custom_fields": {
    "invoice_id": "INV-2025-04812",
...
var client = new RestClient("https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/blockchain_in/bc_in_01kasd1tthf1ns1pjn1kncctwd")! as URL,
