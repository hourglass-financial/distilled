...
PATCH https://api.erebor.bank/blockchain_out/{id}
...
Reference: https://docs.erebor.bank/api-reference/payments/blockchain/outbound/update-outbound-blockchain-transfer
...
paths:
  /blockchain_out/{id}:
    patch:
      operationId: update-outbound-blockchain-transfer
      summary: Update Outbound Blockchain Transfer
      description: >-
        Update an outbound blockchain transfer's `custom_ref` or
        `custom_fields`. Amount, parties, network, and status are immutable.
      tags:
      ...
      responses:
        '200':
          description: Outbound blockchain transfer updated successfully
          content:
            application/json:
              schema:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/UpdateOutboundBlockchainTransferRequest'
servers:
...
components:
  schemas:
    ...
    CustomFields:
      ...
      title: CustomFields
    UpdateOutboundBlockchainTransferRequest:
      type: object
      properties:
        custom_ref:
      ...
      title: UpdateOutboundBlockchainTransferRequest
...
const options = {
  ...
  body: '{"custom_ref":"PAYOUT-2025-04812","custom_fields":{"payout_batch":"B-2025-04-15","recipient_id":"u_abc123"}}'
};
...
HttpResponse<String> response = Unirest.patch("https://api.erebor.bank/blockchain_out/bc_out_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('PATCH', 'https://api.erebor.bank/blockchain_out/bc_out_01kasd1tthf1ns1pjn1kncctwd', [
  'body' => '{
  "custom_ref": "PAYOUT-2025-04812",
  "custom_fields": {
    "payout_batch": "B-2025-04-15",
