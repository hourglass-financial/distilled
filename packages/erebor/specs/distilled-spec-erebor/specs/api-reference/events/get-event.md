...
GET https://api.erebor.bank/events/{id}

Retrieve a specific Event by ID

Reference: https://docs.erebor.bank/api-reference/events/get-event
...
```json
{
  ...
  "resource": {
    ...
    "url": "https://api.erebor.so/deposit_accounts/dep_acct_01kasd1tthf1ns1pjn1kncctwd",
    "created_at": "2025-01-15T09:30:00Z",
    "updated_at": "2025-01-15T09:30:00Z",
    ...
    "account_numbers": [
      {
        ...
        "type": "account_number",
        "url": "https://api.erebor.so/account_numbers/acct_num_01kasd1tthf1ns1pjn1kncctwd",
        "created_at": "2025-01-15T09:30:00Z",
        "updated_at": "2025-01-15T09:30:00Z",
  ...
  "trace": {
    ...
    "request_idempotency_key": "user-key-123"
  }
}
```
...
```javascript
const url = 'https://api.erebor.bank/events/evt_01kasd1tthf1ns1pjn1kncctwd';
...
url = URI("https://api.erebor.bank/events/evt_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.get("https://api.erebor.bank/events/evt_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('GET', 'https://api.erebor.bank/events/evt_01kasd1tthf1ns1pjn1kncctwd', [
  'headers' => [
...
var client = new RestClient("https://api.erebor.bank/events/evt_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/events/evt_01kasd1tthf1ns1pjn1kncctwd")! as URL,
