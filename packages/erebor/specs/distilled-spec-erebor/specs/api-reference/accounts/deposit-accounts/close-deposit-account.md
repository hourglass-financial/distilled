...
paths:
  /deposit_accounts/{id}/close:
    post:
      ...
      responses:
        '200':
          description: Deposit Account closed successfully
          content:
            application/json:
              schema:
...
url = "https://api.erebor.bank/deposit_accounts/id/close"
...
```javascript
const url = 'https://api.erebor.bank/deposit_accounts/id/close';
...
url = URI("https://api.erebor.bank/deposit_accounts/id/close")
...
HttpResponse<String> response = Unirest.post("https://api.erebor.bank/deposit_accounts/id/close")
...
$response = $client->request('POST', 'https://api.erebor.bank/deposit_accounts/id/close', [
  'headers' => [
...
var client = new RestClient("https://api.erebor.bank/deposit_accounts/id/close");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/deposit_accounts/id/close")! as URL,
