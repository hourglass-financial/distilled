...
GET https://api.erebor.bank/account_numbers

Retrieve a paginated list of Account Numbers

Reference: https://docs.erebor.bank/api-reference/accounts/account-numbers/list-account-numbers
...
paths:
  /account_numbers:
    get:
      ...
      description: Retrieve a paginated list of Account Numbers
      tags:
        ...
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/ACCOUNT_NUMBERS_listAccountNumbers_Response_200
servers:
  ...
  schemas:
    ...
    AccountNumber:
      ...
      required:
        ...
        - default
      title: AccountNumber
    ACCOUNT_NUMBERS_listAccountNumbers_Response_200:
      type: object
      properties:
        data:
          type: array
      ...
      required:
        ...
        - page_size
        - url
      title: ACCOUNT_NUMBERS_listAccountNumbers_Response_200
  securitySchemes:
    ApiKeyAuth:
      type: apiKey
      in: header
...
```json
{
  "has_more": true,
  "page_size": 1,
  "url": "https://api.erebor.bank/account_numbers?page_size=1",
  "data": [
    {
  ...
  "page_next": "https://api.erebor.bank/account_numbers?starting_after=acct_num_01kasd1tthf1ns1pjn1kncctwd&page_size=1",
  "page_prev": null
}
```
...
```python List of Account Numbers
import requests

url = "https://api.erebor.bank/account_numbers"
...
```javascript List of Account Numbers
const url = 'https://api.erebor.bank/account_numbers';
...
```ruby List of Account Numbers
require 'uri'
require 'net/http'

url = URI("https://api.erebor.bank/account_numbers")
...
```java List of Account Numbers
import com.mashape.unirest.http.HttpResponse;
import com.mashape.unirest.http.Unirest;

HttpResponse<String> response = Unirest.get("https://api.erebor.bank/account_numbers")
  .header("Authorization", "<apiKey>")
  .asString();
```

```php List of Account Numbers
<?php
require_once('vendor/autoload.php');

$client = new \GuzzleHttp\Client();

$response = $client->request('GET', 'https://api.erebor.bank/account_numbers', [
  'headers' => [
...
```csharp List of Account Numbers
using RestSharp;

var client = new RestClient("https://api.erebor.bank/account_numbers");
var request = new RestRequest(Method.GET);
request.AddHeader("Authorization", "<apiKey>");
IRestResponse response = client.Execute(request);
```

```swift List of Account Numbers
import Foundation

let headers = ["Authorization": "<apiKey>"]

let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/account_numbers")! as URL,
