...
GET https://api.erebor.bank/webhooks/{id}

Retrieve a specific Webhook by ID.

Reference: https://docs.erebor.bank/api-reference/webhooks/get-webhook
...
```javascript
const url = 'https://api.erebor.bank/webhooks/whk_01kasd1tthf1ns1pjn1kncctwd';
...
url = URI("https://api.erebor.bank/webhooks/whk_01kasd1tthf1ns1pjn1kncctwd")
...
HttpResponse<String> response = Unirest.get("https://api.erebor.bank/webhooks/whk_01kasd1tthf1ns1pjn1kncctwd")
...
$response = $client->request('GET', 'https://api.erebor.bank/webhooks/whk_01kasd1tthf1ns1pjn1kncctwd', [
  'headers' => [
...
var client = new RestClient("https://api.erebor.bank/webhooks/whk_01kasd1tthf1ns1pjn1kncctwd");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/webhooks/whk_01kasd1tthf1ns1pjn1kncctwd")! as URL,
