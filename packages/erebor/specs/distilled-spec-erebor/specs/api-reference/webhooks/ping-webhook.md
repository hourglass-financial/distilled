...
POST https://api.erebor.bank/webhooks/{id}/ping

Send a test event to a Webhook endpoint.

Reference: https://docs.erebor.bank/api-reference/webhooks/ping-webhook
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/WebhookPingResponse'
        '404':
...
url = "https://api.erebor.bank/webhooks/id/ping"
...
```javascript
const url = 'https://api.erebor.bank/webhooks/id/ping';
const options = {
  method: 'POST',
...
url = URI("https://api.erebor.bank/webhooks/id/ping")
...
HttpResponse<String> response = Unirest.post("https://api.erebor.bank/webhooks/id/ping")
...
$response = $client->request('POST', 'https://api.erebor.bank/webhooks/id/ping', [
  'body' => '{}',
  'headers' => [
    'Authorization' => '<apiKey>',
    'Content-Type' => 'application/json',
...
var client = new RestClient("https://api.erebor.bank/webhooks/id/ping");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.erebor.bank/webhooks/id/ping")! as URL,
