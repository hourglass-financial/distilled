...
// Input Schema
export interface MarkAnInquiryForReviewInput {
  inquiryId: string;
  include?: string;
...
export const MarkAnInquiryForReviewInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/inquiries/{inquiryId}/mark-for-review" }),
  ) as unknown as Schema.Codec<MarkAnInquiryForReviewInput>;

// Output Schema
export interface MarkAnInquiryForReviewOutput {
  data: {
    type: string;
    id: string;
    attributes: {
...
export const MarkAnInquiryForReviewOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
      type: Schema.String,
      id: Schema.String,
  ...
  }) as unknown as Schema.Codec<MarkAnInquiryForReviewOutput>;
 ...
 */
export const markAnInquiryForReview = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: MarkAnInquiryForReviewInput,
    outputSchema: MarkAnInquiryForReviewOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
