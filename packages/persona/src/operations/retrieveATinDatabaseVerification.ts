    ...
    data: Schema.Struct({
      ...
      attributes: Schema.optional(
        Schema.Struct({
          ...
          tin: Schema.optional(Schema.String),
          "tin-type": Schema.optional(Schema.NullOr(Schema.String)),
          "name-first": Schema.optional(Schema.NullOr(Schema.String)),
          "name-last": Schema.optional(Schema.NullOr(Schema.String)),
          "name-business": Schema.optional(Schema.NullOr(Schema.String)),
        }),
      ),
 ...
 */
export const retrieveATinDatabaseVerification =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: RetrieveATinDatabaseVerificationInput,
    outputSchema: RetrieveATinDatabaseVerificationOutput,
