...
}).pipe(T.Http({ method: "POST", path: "/reports/{reportId}/add-tag" }));
export type ReportsAddTagInput = typeof ReportsAddTagInput.Type;
...
export type ReportsAddTagOutput = typeof ReportsAddTagOutput.Type;
