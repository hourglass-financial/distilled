...
export type TransactionsRemoveTagInput = typeof TransactionsRemoveTagInput.Type;
...
export type TransactionsRemoveTagOutput =
  typeof TransactionsRemoveTagOutput.Type;
