...
export const RemovePersonaObjectsInput =
  ...
  }).pipe(T.Http({ method: "POST", path: "/cases/{caseId}/remove-objects" }));
export type RemovePersonaObjectsInput = typeof RemovePersonaObjectsInput.Type;
...
export type RemovePersonaObjectsOutput = typeof RemovePersonaObjectsOutput.Type;
