...
// Input Schema
export interface RemovePersonaObjectsInput {
  caseId: string;
  include?: string;
...
export const RemovePersonaObjectsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    meta: Schema.optional(
      Schema.Struct({
        "object-ids": Schema.optional(
          Schema.NullOr(Schema.Array(Schema.String)),
        ),
      }),
    ),
  }).pipe(
    T.Http({ method: "POST", path: "/cases/{caseId}/remove-objects" }),
  ) as unknown as Schema.Codec<RemovePersonaObjectsInput>;

// Output Schema
export interface RemovePersonaObjectsOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const RemovePersonaObjectsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<RemovePersonaObjectsOutput>;

// The operation
/**
 * Remove Persona objects from a Case
 *
 ...
 */
export const removePersonaObjects = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: RemovePersonaObjectsInput,
    outputSchema: RemovePersonaObjectsOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
