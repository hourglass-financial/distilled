 ...
 * @param caseId - ID of the case to update status
 */
export const setStatusForACase = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: SetStatusForACaseInput,
  outputSchema: SetStatusForACaseOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
