...
}).pipe(T.Http({ method: "POST", path: "/webhooks/{webhookId}/clone" }));
export type CloneAWebhookInput = typeof CloneAWebhookInput.Type;
...
export type CloneAWebhookOutput = typeof CloneAWebhookOutput.Type;
