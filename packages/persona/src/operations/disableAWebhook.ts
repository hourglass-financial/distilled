...
// Input Schema
export interface DisableAWebhookInput {
  webhookId: string;
  include?: string;
...
export const DisableAWebhookInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/webhooks/{webhookId}/disable" }),
) as unknown as Schema.Codec<DisableAWebhookInput>;

// Output Schema
export interface DisableAWebhookOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const DisableAWebhookOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}) as unknown as Schema.Codec<DisableAWebhookOutput>;
 ...
 */
export const disableAWebhook = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DisableAWebhookInput,
  outputSchema: DisableAWebhookOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
