...
}).pipe(T.Http({ method: "POST", path: "/webhooks/{webhookId}/disable" }));
export type DisableAWebhookInput = typeof DisableAWebhookInput.Type;
...
export type DisableAWebhookOutput = typeof DisableAWebhookOutput.Type;
