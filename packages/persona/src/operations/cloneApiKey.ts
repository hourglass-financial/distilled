 ...
 *
 * @param apiKeyId - The token/ID of the API key to be cloned.
 ...
 */
export const cloneApiKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: CloneApiKeyInput,
  outputSchema: CloneApiKeyOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
