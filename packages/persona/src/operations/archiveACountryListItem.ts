...
// Input Schema
export interface ArchiveACountryListItemInput {
  listItemId: string;
  include?: string;
...
export const ArchiveACountryListItemInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "DELETE", path: "/list-item/countries/{listItemId}" }),
  ) as unknown as Schema.Codec<ArchiveACountryListItemInput>;

// Output Schema
export interface ArchiveACountryListItemOutput {
  data: {
    id?: string;
    type?: string;
    attributes?: {
...
export const ArchiveACountryListItemOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<ArchiveACountryListItemOutput>;
 ...
 */
export const archiveACountryListItem = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ArchiveACountryListItemInput,
    outputSchema: ArchiveACountryListItemOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
