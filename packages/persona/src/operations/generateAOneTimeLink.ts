 ...
 * @param inquiryId - Inquiry ID (starts with "inq_")
 */
export const generateAOneTimeLink = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GenerateAOneTimeLinkInput,
    outputSchema: GenerateAOneTimeLinkOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
