...
).pipe(T.Http({ method: "GET", path: "/rate-limits" }));
export type ListAllRateLimitsInput = typeof ListAllRateLimitsInput.Type;
...
export type ListAllRateLimitsOutput = typeof ListAllRateLimitsOutput.Type;
