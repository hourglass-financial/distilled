...
// Input Schema
export interface RetrieveAnAccountTypeInput {
...
export const RetrieveAnAccountTypeInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/account-types/{accountTypeId}" }),
  ) as unknown as Schema.Codec<RetrieveAnAccountTypeInput>;

// Output Schema
export interface RetrieveAnAccountTypeOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const RetrieveAnAccountTypeOutput =
  ...
  }) as unknown as Schema.Codec<RetrieveAnAccountTypeOutput>;
