...
}).pipe(T.Http({ method: "DELETE", path: "/cases/{caseId}" }));
export type RedactACaseInput = typeof RedactACaseInput.Type;
...
export type RedactACaseOutput = typeof RedactACaseOutput.Type;
