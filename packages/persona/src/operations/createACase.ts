...
}).pipe(T.Http({ method: "POST", path: "/cases" }));
export type CreateACaseInput = typeof CreateACaseInput.Type;
...
export type CreateACaseOutput = typeof CreateACaseOutput.Type;
