...
// Input Schema
export interface AccountsAddRelationInput {
  accountId: string;
  include?: string;
...
export const AccountsAddRelationInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/accounts/{accountId}/add-relation" }),
  ) as unknown as Schema.Codec<AccountsAddRelationInput>;

// Output Schema
export interface AccountsAddRelationOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const AccountsAddRelationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<AccountsAddRelationOutput>;

// The operation
/**
 * Add a relation to an Account
 *
 ...
 */
export const accountsAddRelation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: AccountsAddRelationInput,
  outputSchema: AccountsAddRelationOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
