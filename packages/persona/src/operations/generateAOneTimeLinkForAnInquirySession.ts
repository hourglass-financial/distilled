...
// Input Schema
export interface GenerateAOneTimeLinkForAnInquirySessionInput {
...
export const GenerateAOneTimeLinkForAnInquirySessionInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/inquiry-sessions/{inquirySessionId}/generate-one-time-link",
    }),
  ) as unknown as Schema.Codec<GenerateAOneTimeLinkForAnInquirySessionInput>;

// Output Schema
export interface GenerateAOneTimeLinkForAnInquirySessionOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const GenerateAOneTimeLinkForAnInquirySessionOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<GenerateAOneTimeLinkForAnInquirySessionOutput>;
 ...
 */
export const generateAOneTimeLinkForAnInquirySession =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: GenerateAOneTimeLinkForAnInquirySessionInput,
    outputSchema: GenerateAOneTimeLinkForAnInquirySessionOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
