...
export type TransactionsAddRelationInput =
  typeof TransactionsAddRelationInput.Type;
...
export type TransactionsAddRelationOutput =
  typeof TransactionsAddRelationOutput.Type;
