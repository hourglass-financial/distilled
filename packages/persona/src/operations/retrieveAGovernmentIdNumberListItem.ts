 ...
 */
export const retrieveAGovernmentIdNumberListItem =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: RetrieveAGovernmentIdNumberListItemInput,
    outputSchema: RetrieveAGovernmentIdNumberListItemOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
