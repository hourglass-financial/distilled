...
// Input Schema
export interface RetrieveAGeolocationListItemInput {
  listItemId: string;
  include?: string;
...
export const RetrieveAGeolocationListItemInput =
  ...
  ) as unknown as Schema.Codec<RetrieveAGeolocationListItemInput>;

// Output Schema
export interface RetrieveAGeolocationListItemOutput {
  data: {
    id?: string;
    type?: string;
    attributes?: {
...
export const RetrieveAGeolocationListItemOutput =
  ...
  }) as unknown as Schema.Codec<RetrieveAGeolocationListItemOutput>;
