...
// Input Schema
export interface ImportGeolocationListsInput {
  include?: string;
...
export const ImportGeolocationListsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/importer/list-item/geolocations" }),
  ) as unknown as Schema.Codec<ImportGeolocationListsInput>;

// Output Schema
export interface ImportGeolocationListsOutput {
  data: {
    id?: string;
    type?: string;
    attributes?: {
...
export const ImportGeolocationListsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<ImportGeolocationListsOutput>;
 ...
 */
export const importGeolocationLists = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ImportGeolocationListsInput,
    outputSchema: ImportGeolocationListsOutput,
