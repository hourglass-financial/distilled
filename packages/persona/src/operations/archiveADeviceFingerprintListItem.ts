...
// Input Schema
export interface ArchiveADeviceFingerprintListItemInput {
  listItemId: string;
  include?: string;
...
export const ArchiveADeviceFingerprintListItemInput =
  ...
  ) as unknown as Schema.Codec<ArchiveADeviceFingerprintListItemInput>;

// Output Schema
export interface ArchiveADeviceFingerprintListItemOutput {
  data: {
    id?: string;
    type?: string;
    attributes?: {
...
export const ArchiveADeviceFingerprintListItemOutput =
  ...
  }) as unknown as Schema.Codec<ArchiveADeviceFingerprintListItemOutput>;
