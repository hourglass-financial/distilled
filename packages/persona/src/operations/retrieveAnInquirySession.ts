...
// Input Schema
export interface RetrieveAnInquirySessionInput {
...
export const RetrieveAnInquirySessionInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/inquiry-sessions/{inquirySessionId}" }),
  ) as unknown as Schema.Codec<RetrieveAnInquirySessionInput>;

// Output Schema
export interface RetrieveAnInquirySessionOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const RetrieveAnInquirySessionOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<RetrieveAnInquirySessionOutput>;
 ...
 * @param inquirySessionId - Inquiry Session ID
 */
export const retrieveAnInquirySession = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: RetrieveAnInquirySessionInput,
    outputSchema: RetrieveAnInquirySessionOutput,
