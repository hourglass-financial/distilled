...
}).pipe(T.Http({ method: "POST", path: "/inquiries/{inquiryId}/expire" }));
export type ExpireAnInquiryInput = typeof ExpireAnInquiryInput.Type;
...
export type ExpireAnInquiryOutput = typeof ExpireAnInquiryOutput.Type;
