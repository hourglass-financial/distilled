...
export const AccountsListAllRelationsInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/accounts/{accountId}/relations" }));
export type AccountsListAllRelationsInput =
  typeof AccountsListAllRelationsInput.Type;
...
export type AccountsListAllRelationsOutput =
  typeof AccountsListAllRelationsOutput.Type;
