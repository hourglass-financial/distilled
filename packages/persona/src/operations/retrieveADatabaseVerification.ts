    ...
    data: Schema.Struct({
      ...
      attributes: Schema.optional(
        Schema.Struct({
          ...
          "normalized-address-street-1": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
          "normalized-address-street-2": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
          "normalized-address-city": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
          "normalized-address-subdivision": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
          "normalized-address-postal-code": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
          ...
          "document-issuing-date": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
          "document-expiry-date": Schema.optional(Schema.NullOr(Schema.String)),
          "document-issuing-subdivision": Schema.optional(
            Schema.NullOr(Schema.String),
          ),
        }),
      ),
 ...
 */
export const retrieveADatabaseVerification =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: RetrieveADatabaseVerificationInput,
    outputSchema: RetrieveADatabaseVerificationOutput,
