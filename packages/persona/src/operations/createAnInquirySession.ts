...
export const CreateAnInquirySessionInput =
  ...
  }).pipe(T.Http({ method: "POST", path: "/inquiry-sessions" }));
export type CreateAnInquirySessionInput =
  typeof CreateAnInquirySessionInput.Type;
...
export type CreateAnInquirySessionOutput =
  typeof CreateAnInquirySessionOutput.Type;
