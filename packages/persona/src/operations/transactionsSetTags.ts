...
// Input Schema
export interface TransactionsSetTagsInput {
...
export const TransactionsSetTagsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/transactions/{transactionId}/set-tags" }),
  ) as unknown as Schema.Codec<TransactionsSetTagsInput>;

// Output Schema
export interface TransactionsSetTagsOutput {
  data: {
    id?: string;
    type?: string;
    attributes?: {
...
export const TransactionsSetTagsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<TransactionsSetTagsOutput>;
 ...
 * @param transactionId - ID of the transaction to set tags on.
 */
export const transactionsSetTags = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: TransactionsSetTagsInput,
  outputSchema: TransactionsSetTagsOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
