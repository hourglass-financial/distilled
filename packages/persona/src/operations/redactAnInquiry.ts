...
// Input Schema
export interface RedactAnInquiryInput {
  inquiryId: string;
  include?: string;
...
export const RedactAnInquiryInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "/inquiries/{inquiryId}" }),
) as unknown as Schema.Codec<RedactAnInquiryInput>;

// Output Schema
export interface RedactAnInquiryOutput {
  data: {
    type: string;
    id: string;
    attributes: {
...
export const RedactAnInquiryOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
    type: Schema.String,
    id: Schema.String,
...
}) as unknown as Schema.Codec<RedactAnInquiryOutput>;
 ...
 */
export const redactAnInquiry = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: RedactAnInquiryInput,
  outputSchema: RedactAnInquiryOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
