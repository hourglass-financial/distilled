...
}).pipe(T.Http({ method: "DELETE", path: "/inquiries/{inquiryId}" }));
export type RedactAnInquiryInput = typeof RedactAnInquiryInput.Type;
...
export type RedactAnInquiryOutput = typeof RedactAnInquiryOutput.Type;
