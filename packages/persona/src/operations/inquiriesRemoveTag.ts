...
// Input Schema
export interface InquiriesRemoveTagInput {
  inquiryId: string;
  include?: string;
...
export const InquiriesRemoveTagInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/inquiries/{inquiryId}/remove-tag" }),
  ) as unknown as Schema.Codec<InquiriesRemoveTagInput>;

// Output Schema
export interface InquiriesRemoveTagOutput {
  data: {
    type: string;
    id: string;
    attributes: {
...
export const InquiriesRemoveTagOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
      type: Schema.String,
      id: Schema.String,
  ...
  }) as unknown as Schema.Codec<InquiriesRemoveTagOutput>;
 ...
 */
export const inquiriesRemoveTag = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: InquiriesRemoveTagInput,
  outputSchema: InquiriesRemoveTagOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
