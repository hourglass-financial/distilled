...
// The operation
/**
 * Remove a relation from an Account
 *
 ...
 */
export const accountsRemoveRelation = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: AccountsRemoveRelationInput,
    outputSchema: AccountsRemoveRelationOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
