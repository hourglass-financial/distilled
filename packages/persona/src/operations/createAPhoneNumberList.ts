...
export const CreateAPhoneNumberListInput =
  ...
  }).pipe(T.Http({ method: "POST", path: "/list/phone-numbers" }));
export type CreateAPhoneNumberListInput =
  typeof CreateAPhoneNumberListInput.Type;
...
export type CreateAPhoneNumberListOutput =
  typeof CreateAPhoneNumberListOutput.Type;
