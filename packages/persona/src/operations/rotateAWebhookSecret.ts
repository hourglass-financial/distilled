...
// Input Schema
export interface RotateAWebhookSecretInput {
  webhookId: string;
  include?: string;
...
export const RotateAWebhookSecretInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/webhooks/{webhookId}/rotate-secret" }),
  ) as unknown as Schema.Codec<RotateAWebhookSecretInput>;

// Output Schema
export interface RotateAWebhookSecretOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const RotateAWebhookSecretOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<RotateAWebhookSecretOutput>;
 ...
 */
export const rotateAWebhookSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: RotateAWebhookSecretInput,
    outputSchema: RotateAWebhookSecretOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
