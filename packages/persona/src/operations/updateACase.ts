...
// Input Schema
export interface UpdateACaseInput {
  caseId: string;
  include?: string;
  ...
  data?: {
    attributes?: {
      attachments?: ReadonlyArray<{ data?: string; filename?: string }>;
      "case-queue-id"?: string | null;
      fields?: Record<string, unknown>;
    };
  };
  meta?: { "sla-expires-in-seconds"?: number | null };
}
export const UpdateACaseInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    Schema.Struct({
      attributes: Schema.optional(
        Schema.Struct({
          ...
          "case-queue-id": Schema.optional(Schema.NullOr(Schema.String)),
  ...
  T.Http({ method: "PATCH", path: "/cases/{caseId}" }),
) as unknown as Schema.Codec<UpdateACaseInput>;

// Output Schema
export interface UpdateACaseOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const UpdateACaseOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}) as unknown as Schema.Codec<UpdateACaseOutput>;
 ...
 */
export const updateACase = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateACaseInput,
  outputSchema: UpdateACaseOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
