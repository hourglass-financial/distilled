...
}).pipe(T.Http({ method: "PATCH", path: "/cases/{caseId}" }));
export type UpdateACaseInput = typeof UpdateACaseInput.Type;
...
export type UpdateACaseOutput = typeof UpdateACaseOutput.Type;
