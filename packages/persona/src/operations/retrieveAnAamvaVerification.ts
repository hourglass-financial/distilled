    ...
    data: Schema.Struct({
      ...
      attributes: Schema.optional(
        Schema.Struct({
          ...
          "issue-date": Schema.optional(Schema.String),
          "expiration-date": Schema.optional(Schema.String),
          "address-postal-code": Schema.optional(Schema.String),
          "issuing-authority": Schema.optional(Schema.String),
          "identification-number": Schema.optional(Schema.String),
        }),
      ),
 ...
 */
export const retrieveAnAamvaVerification = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: RetrieveAnAamvaVerificationInput,
    outputSchema: RetrieveAnAamvaVerificationOutput,
