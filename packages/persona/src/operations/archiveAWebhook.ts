...
// Input Schema
export interface ArchiveAWebhookInput {
  webhookId: string;
  include?: string;
...
export const ArchiveAWebhookInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/webhooks/{webhookId}/archive" }),
) as unknown as Schema.Codec<ArchiveAWebhookInput>;

// Output Schema
export interface ArchiveAWebhookOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
}) as unknown as Schema.Codec<ArchiveAWebhookOutput>;
