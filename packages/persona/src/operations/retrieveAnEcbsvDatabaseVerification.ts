...
// Input Schema
export interface RetrieveAnEcbsvDatabaseVerificationInput {
...
export const RetrieveAnEcbsvDatabaseVerificationInput =
  ...
  ) as unknown as Schema.Codec<RetrieveAnEcbsvDatabaseVerificationInput>;

// Output Schema
export interface RetrieveAnEcbsvDatabaseVerificationOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
      ...
      "signature-timestamp"?: string | null;
      "signature-ip"?: string | null;
    };
    relationships?: {
...
export const RetrieveAnEcbsvDatabaseVerificationOutput =
  ...
  }) as unknown as Schema.Codec<RetrieveAnEcbsvDatabaseVerificationOutput>;
