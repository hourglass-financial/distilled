...
// Input Schema
export interface DeclineAnInquiryInput {
  inquiryId: string;
  include?: string;
...
export const DeclineAnInquiryInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/inquiries/{inquiryId}/decline" }),
) as unknown as Schema.Codec<DeclineAnInquiryInput>;

// Output Schema
export interface DeclineAnInquiryOutput {
  data: {
    type: string;
    id: string;
    attributes: {
...
export const DeclineAnInquiryOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    data: Schema.Struct({
      type: Schema.String,
      id: Schema.String,
...
) as unknown as Schema.Codec<DeclineAnInquiryOutput>;
 ...
 * Declining an inquiry will prevent further progress on the inquiry.
 *
 ...
 */
export const declineAnInquiry = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DeclineAnInquiryInput,
  outputSchema: DeclineAnInquiryOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
