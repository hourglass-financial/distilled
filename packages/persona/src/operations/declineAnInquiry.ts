...
}).pipe(T.Http({ method: "POST", path: "/inquiries/{inquiryId}/decline" }));
export type DeclineAnInquiryInput = typeof DeclineAnInquiryInput.Type;
...
export type DeclineAnInquiryOutput = typeof DeclineAnInquiryOutput.Type;
