...
}).pipe(T.Http({ method: "POST", path: "/inquiries/{inquiryId}/approve" }));
export type ApproveAnInquiryInput = typeof ApproveAnInquiryInput.Type;
...
export type ApproveAnInquiryOutput = typeof ApproveAnInquiryOutput.Type;
