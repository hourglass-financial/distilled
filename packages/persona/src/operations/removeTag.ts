...
// Input Schema
export const RemoveTagInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/cases/{caseId}/remove-tag" }));
export type RemoveTagInput = typeof RemoveTagInput.Type;

// Output Schema
export const RemoveTagOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
export type RemoveTagOutput = typeof RemoveTagOutput.Type;
 ...
 */
export const removeTag = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: RemoveTagInput,
