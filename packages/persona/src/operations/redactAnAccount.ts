...
// Input Schema
export interface RedactAnAccountInput {
  accountId: string;
  include?: string;
...
export const RedactAnAccountInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "/accounts/{accountId}" }),
) as unknown as Schema.Codec<RedactAnAccountInput>;

// Output Schema
export interface RedactAnAccountOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const RedactAnAccountOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}) as unknown as Schema.Codec<RedactAnAccountOutput>;
 ...
 */
export const redactAnAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: RedactAnAccountInput,
  outputSchema: RedactAnAccountOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
