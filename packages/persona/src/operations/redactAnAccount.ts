...
}).pipe(T.Http({ method: "DELETE", path: "/accounts/{accountId}" }));
export type RedactAnAccountInput = typeof RedactAnAccountInput.Type;
...
export type RedactAnAccountOutput = typeof RedactAnAccountOutput.Type;
