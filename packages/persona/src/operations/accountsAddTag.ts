...
}).pipe(T.Http({ method: "POST", path: "/accounts/{accountId}/add-tag" }));
export type AccountsAddTagInput = typeof AccountsAddTagInput.Type;
...
export type AccountsAddTagOutput = typeof AccountsAddTagOutput.Type;
