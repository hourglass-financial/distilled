...
).pipe(T.Http({ method: "GET", path: "/inquiries/{inquiryId}" }));
export type RetrieveAnInquiryInput = typeof RetrieveAnInquiryInput.Type;
...
export type RetrieveAnInquiryOutput = typeof RetrieveAnInquiryOutput.Type;
