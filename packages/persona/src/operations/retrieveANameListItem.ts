...
// Input Schema
export interface RetrieveANameListItemInput {
  listItemId: string;
  include?: string;
...
export const RetrieveANameListItemInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/list-item/names/{listItemId}" }),
  ) as unknown as Schema.Codec<RetrieveANameListItemInput>;

// Output Schema
export interface RetrieveANameListItemOutput {
  data: {
    id?: string;
    type?: string;
    attributes?: {
...
export const RetrieveANameListItemOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Struct({
  ...
  }) as unknown as Schema.Codec<RetrieveANameListItemOutput>;
 ...
 */
export const retrieveANameListItem = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: RetrieveANameListItemInput,
    outputSchema: RetrieveANameListItemOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
