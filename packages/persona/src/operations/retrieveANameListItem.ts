...
export const RetrieveANameListItemInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/list-item/names/{listItemId}" }));
export type RetrieveANameListItemInput = typeof RetrieveANameListItemInput.Type;
...
export type RetrieveANameListItemOutput =
  typeof RetrieveANameListItemOutput.Type;
