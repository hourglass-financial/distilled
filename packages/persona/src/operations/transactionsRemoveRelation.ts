...
// The operation
/**
 * Remove relation from Transaction
 *
 ...
 * @param transactionId - ID of the transaction to remove the relation from.
 */
export const transactionsRemoveRelation = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: TransactionsRemoveRelationInput,
    outputSchema: TransactionsRemoveRelationOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
