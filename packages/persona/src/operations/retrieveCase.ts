...
// Input Schema
export interface RetrieveCaseInput {
  caseId: string;
  include?: string;
...
export const RetrieveCaseInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "GET", path: "/cases/{caseId}" }),
) as unknown as Schema.Codec<RetrieveCaseInput>;

// Output Schema
export interface RetrieveCaseOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const RetrieveCaseOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}) as unknown as Schema.Codec<RetrieveCaseOutput>;
 ...
 */
export const retrieveCase = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: RetrieveCaseInput,
  outputSchema: RetrieveCaseOutput,
