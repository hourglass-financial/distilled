...
}).pipe(T.Http({ method: "GET", path: "/cases/{caseId}" }));
export type RetrieveCaseInput = typeof RetrieveCaseInput.Type;
...
export type RetrieveCaseOutput = typeof RetrieveCaseOutput.Type;
