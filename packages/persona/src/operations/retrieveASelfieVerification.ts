    ...
    data: Schema.Struct({
      ...
      attributes: Schema.optional(
        Schema.Struct({
          ...
          "center-photo-face-coordinates": Schema.optional(
            Schema.NullOr(
              Schema.Struct({
                "top-left": Schema.optional(Schema.Array(Schema.Number)),
                "top-right": Schema.optional(Schema.Array(Schema.Number)),
                "bottom-left": Schema.optional(Schema.Array(Schema.Number)),
                "bottom-right": Schema.optional(Schema.Array(Schema.Number)),
              }),
            ),
          ),
          "center-photo-url": Schema.optional(Schema.NullOr(Schema.String)),
          "document-similarity-score": Schema.optional(
            Schema.NullOr(Schema.Number),
          ),
          "entity-confidence-reasons": Schema.optional(
            Schema.Array(Schema.String),
          ),
          "left-photo-url": Schema.optional(Schema.NullOr(Schema.String)),
          ...
          "right-photo-url": Schema.optional(Schema.NullOr(Schema.String)),
          "selfie-similarity-score-left": Schema.optional(
            Schema.NullOr(Schema.Number),
          ),
          "selfie-similarity-score-right": Schema.optional(
            Schema.NullOr(Schema.Number),
          ),
 ...
 */
export const retrieveASelfieVerification = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: RetrieveASelfieVerificationInput,
    outputSchema: RetrieveASelfieVerificationOutput,
