...
) as unknown as Schema.Codec<CreateAnAccountInput>;

// Output Schema
export interface CreateAnAccountOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
}) as unknown as Schema.Codec<CreateAnAccountOutput>;
