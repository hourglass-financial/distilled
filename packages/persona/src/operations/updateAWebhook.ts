...
// Input Schema
export interface UpdateAWebhookInput {
  webhookId: string;
  include?: string;
...
export const UpdateAWebhookInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/webhooks/{webhookId}" }),
) as unknown as Schema.Codec<UpdateAWebhookInput>;

// Output Schema
export interface UpdateAWebhookOutput {
  data: {
    type?: string;
    id?: string;
    attributes?: {
...
export const UpdateAWebhookOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}) as unknown as Schema.Codec<UpdateAWebhookOutput>;
 ...
 */
export const updateAWebhook = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateAWebhookInput,
  outputSchema: UpdateAWebhookOutput,
  errors: [
    BadRequest,
    Forbidden,
    NotFound,
