...
}).pipe(T.Http({ method: "PATCH", path: "/webhooks/{webhookId}" }));
export type UpdateAWebhookInput = typeof UpdateAWebhookInput.Type;
...
export type UpdateAWebhookOutput = typeof UpdateAWebhookOutput.Type;
