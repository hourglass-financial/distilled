...
// Input Schema
export const AddTagInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/cases/{caseId}/add-tag" }));
export type AddTagInput = typeof AddTagInput.Type;

// Output Schema
export const AddTagOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
export type AddTagOutput = typeof AddTagOutput.Type;
 ...
 */
export const addTag = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: AddTagInput,
