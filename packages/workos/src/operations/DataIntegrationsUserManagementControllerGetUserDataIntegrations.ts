...
export const DataIntegrationsUserManagementControllerGetUserDataIntegrationsInput =
  ...
  ) as unknown as GeneratedStructCodec<DataIntegrationsUserManagementControllerGetUserDataIntegrationsInput>;
...
export const DataIntegrationsUserManagementControllerGetUserDataIntegrationsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    data: Schema.Array(
      Schema.Struct({
        object: Schema.Literals(["data_provider"]),
        id: Schema.String,
        name: Schema.String,
  ...
  }) as unknown as GeneratedStructCodec<DataIntegrationsUserManagementControllerGetUserDataIntegrationsOutput>;
