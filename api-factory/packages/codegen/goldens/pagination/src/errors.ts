 ...
 *   - error codes / status table → the Orbit OpenAPI spec + generator mapping
...
/**
 * A Orbit error the SDK does not (yet) model — an unmapped status or an
 ...
 */
export class UnknownOrbitError extends Schema.TaggedErrorClass<UnknownOrbitError>()(
  "UnknownOrbitError",
  {
 ...
 */
export class OrbitTransportError extends Schema.TaggedErrorClass<OrbitTransportError>()(
  "OrbitTransportError",
 ...
 */
export class OrbitDecodeError extends Schema.TaggedErrorClass<OrbitDecodeError>()(
  "OrbitDecodeError",
  {
    message: Schema.String,
...
/**
 * Orbit discriminator code → typed error class, derived from each class's
...
/** Errors that can arise on any Orbit operation (401/429/5xx). */
export const DEFAULT_ERRORS = CORE_DEFAULT_ERRORS;

/** Instance union of {@link DEFAULT_ERRORS}. */
export type OrbitUniversalError = InstanceType<(typeof DEFAULT_ERRORS)[number]>;

/**
 * Everything a Orbit operation can fail with *beyond* its own declared typed
