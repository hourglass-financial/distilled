 ...
 *   - error codes / status table → the Array Success OpenAPI spec + generator mapping
...
/**
 * A Array Success error the SDK does not (yet) model — an unmapped status or an
 ...
 */
export class UnknownArraySuccessError extends Schema.TaggedErrorClass<UnknownArraySuccessError>()(
 ...
 */
export class ArraySuccessTransportError extends Schema.TaggedErrorClass<ArraySuccessTransportError>()(
 ...
 */
export class ArraySuccessDecodeError extends Schema.TaggedErrorClass<ArraySuccessDecodeError>()(
...
/**
 * Array Success discriminator code → typed error class, derived from each class's
...
/** Errors that can arise on any Array Success operation (401/429/5xx). */
export const DEFAULT_ERRORS = CORE_DEFAULT_ERRORS;

/** Instance union of {@link DEFAULT_ERRORS}. */
export type ArraySuccessUniversalError = InstanceType<
  (typeof DEFAULT_ERRORS)[number]
>;

/**
 * Everything a Array Success operation can fail with *beyond* its own declared typed
 ...
 */
export type ArraySuccessExtraError =
  | ArraySuccessUniversalError
  | UnknownArraySuccessError
  | ArraySuccessTransportError
  | ArraySuccessDecodeError;
