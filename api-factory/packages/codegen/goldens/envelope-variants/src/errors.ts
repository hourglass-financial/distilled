 ...
 *   - error codes / status table → the Envelope Variants OpenAPI spec + generator mapping
...
/**
 * A Envelope Variants error the SDK does not (yet) model — an unmapped status or an
 ...
 */
export class UnknownEnvelopeVariantsError extends Schema.TaggedErrorClass<UnknownEnvelopeVariantsError>()(
 ...
 */
export class EnvelopeVariantsTransportError extends Schema.TaggedErrorClass<EnvelopeVariantsTransportError>()(
 ...
 */
export class EnvelopeVariantsDecodeError extends Schema.TaggedErrorClass<EnvelopeVariantsDecodeError>()(
...
/**
 * Envelope Variants discriminator code → typed error class, derived from each class's
...
/** Errors that can arise on any Envelope Variants operation (401/429/5xx). */
export const DEFAULT_ERRORS = CORE_DEFAULT_ERRORS;

/** Instance union of {@link DEFAULT_ERRORS}. */
export type EnvelopeVariantsUniversalError = InstanceType<
  (typeof DEFAULT_ERRORS)[number]
>;

/**
 * Everything a Envelope Variants operation can fail with *beyond* its own declared typed
 ...
 */
export type EnvelopeVariantsExtraError =
  | EnvelopeVariantsUniversalError
  | UnknownEnvelopeVariantsError
  | EnvelopeVariantsTransportError
  | EnvelopeVariantsDecodeError;
