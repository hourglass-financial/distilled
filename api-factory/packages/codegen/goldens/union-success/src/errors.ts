 ...
 *   - error codes / status table → the Union Success OpenAPI spec + generator mapping
...
/**
 * A Union Success error the SDK does not (yet) model — an unmapped status or an
 ...
 */
export class UnknownUnionSuccessError extends Schema.TaggedErrorClass<UnknownUnionSuccessError>()(
 ...
 */
export class UnionSuccessTransportError extends Schema.TaggedErrorClass<UnionSuccessTransportError>()(
 ...
 */
export class UnionSuccessDecodeError extends Schema.TaggedErrorClass<UnionSuccessDecodeError>()(
...
/**
 * Union Success discriminator code → typed error class, derived from each class's
...
/** Errors that can arise on any Union Success operation (401/429/5xx). */
export const DEFAULT_ERRORS = CORE_DEFAULT_ERRORS;

/** Instance union of {@link DEFAULT_ERRORS}. */
export type UnionSuccessUniversalError = InstanceType<
  (typeof DEFAULT_ERRORS)[number]
>;

/**
 * Everything a Union Success operation can fail with *beyond* its own declared typed
 ...
 */
export type UnionSuccessExtraError =
  | UnionSuccessUniversalError
  | UnknownUnionSuccessError
  | UnionSuccessTransportError
  | UnionSuccessDecodeError;
