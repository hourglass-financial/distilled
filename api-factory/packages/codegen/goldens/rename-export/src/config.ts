...
export const config: Config.Config<QuarryConfig> = credentialsConfig({
  apiKeyVar: "QUARRY_API_KEY",
  baseUrlVar: "QUARRY_API_URL",
...
export const credentialsFromEnv: Layer.Layer<Credentials, ConfigError> =
  Layer.effect(
    ...
    credentialsFromEnvEffect(
      ...
      "Quarry credentials are not configured.",
